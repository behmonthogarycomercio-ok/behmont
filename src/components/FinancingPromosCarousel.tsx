...
export default function FinancingPromosCarousel({
  ...
  return (
    <section className="bg-steel-900 py-[42px] lg:py-[52px]">
            ...
            <ProductCarousel>
              {items.map((item, i) => (
                <button
                  ...
                  className="group shrink-0 w-[150px] sm:w-[190px] relative overflow-hidden rounded-[16px] border border-white/10 bg-white"
